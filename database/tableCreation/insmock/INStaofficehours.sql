insert into tafor(netid, course_id, avail_id, status) values('mphelps3', 2, 1, 'I am here');

insert into tafor(netid, course_id, avail_id, status) values('pfalvey', 1, 2, 'I am there');
